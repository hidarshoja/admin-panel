...
const navigation = [
  ...
  { name: "تعریف مشتری ",href: "/harvest",icon: CreditCardIcon,current: false},
  { name: "سطوح دسترسی",href: "/buyGold",icon: MdPriceChange,current: false},
  { name: "نگاه آماری", href: "/profile", icon: CiUser, current: false },
  { name: "پشتیبانی", href: "/support", icon: CiUser, current: false },
  { name: "حسابداری ",icon: ScaleIcon,current: false,
    children: [
      { name: "برداشت", href: "/deposit" },
      { name: "  تبدیل", href: "/receive-gold" },
      { name: "کیف ریالی", href: "/report" },
      { name: "کیف crypto", href: "/report" },
      { name: "کیف فیات", href: "/report" },
      { name: "کیف حواله", href: "/report" },
      { name: "کیف طلا", href: "/report" },
      { name: "کیف سرمایه گذاری", href: "/report" },
    ],
  },
];
            ...
            <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-color1 px-6 pb-4">
              <div className="flex h-20 shrink-0 items-center mt-3 justify-between">
                <img
                  ...
                  alt="Your Company"
                />
                <h3 className="text-xl text-color2"> پنل مدیریت</h3>
              </div>
                                  ...
                                  <Disclosure.Button
                                    className={classNames(
                                      item.current
                                        ? "bg-gray-50"
                                        : "hover:bg-gray-50 hover:text-gray-700",
                                      "flex justify-between items-center w-full  rounded-md p-2 gap-x-3 text-sm leading-6 font-semibold text-gray-100"
                                    )}
                                  >
                                    <ChevronRightIcon
                                      className={classNames(
            ...
            <main className="py-10">
              <div>
                <Routes>
                  ...
                  <Route path="/support" element={<Support users={users} />} />
                  <Route path="/support/chat/:id" element={<Chat users={users} />} />
                </Routes>
              </div>
            </main>
          </div>
