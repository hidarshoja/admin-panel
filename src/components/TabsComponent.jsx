...
export default function TabsComponent({ trueKeys }) {
  ...
  const handleClickSave = async () => {
    try {
      const formData = {
        cashinPercent: document.getElementById("Percent").value,
        cashoutWage: document.getElementById("Wage").value,
        cashinNetworkCost: document.getElementById("cashinIn").value,
        cashoutNetworkCost: document.getElementById("cashoutCost").value,
        customerName: document.getElementById("customerName").value,
        walletToWalletEnabled: enabled,
        walletToWalletFee: enabled ? document.getElementById("bagWallet").value : null,
        dailyWithdrawalLimit: document.getElementById("dayPrice").value,
        optionalCardNumber: value
      };
      ...
      // Navigate or perform any other action after successful post
    } catch (error) {
            ...
            <div>
              ...
              <div>
                ...
                <div className="flex gap-2 mt-5 items-center justify-end">
                  ...
                  className="flex items-center justify-center w-1/2 md:w-1/4 bg-green-500 rounded-lg py-2 text-color3 hover:bg-green-700">
                    ذخیره
                  </button>
                </div>
              </div>
